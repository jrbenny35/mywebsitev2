  ...
  var methods = {
    init: function(options) {
      ...
      return this.each(function() {
        ...
        container      = $('.kyco_googleplusfeed' + "."  + settings.lang.langCode + '#feed_' + selector.attr('class'));
        loader         = $('div.feed_loader' + ' ' + settings.lang.loading);
        wrapper        = $('div.feed_wrapper');
        header         = $('div.feed_header');
        screenName     = $('h3.feed_screen_name' + '\n' + '\t' +  'a(href="#", target="_blank" ');
        profileImage   = $('a' + '.feed_profile_image(href="#", target="_blank")');
        content        = $('div.feed_content');
        showMoreButton = $('span.feed_show_more' + settings.lang.showMore );
        errorMessage   = $('div.error');
        retryButton    = $('span.retry');
